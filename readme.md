...
![ML Domains](https://img.shields.io/badge/ML%20Domains-5-cyan?style=flat-square)
![Deployed](https://img.shields.io/badge/Deployed-100%25-success?style=flat-square)
...
|---|---|---|
| Clustering | ![Clustering](https://img.shields.io/badge/Clustering-8-blueviolet?style=flat-square) | TrendCluster, ClusterVibe, ClusterVerse, ML Clustering, Clustering Dashboard... |
| Classification | ![Classification](https://img.shields.io/badge/Classification-3-blue?style=flat-square) | Random Forest (×3), Classification App |
| Neural Networks | ![Neural Net](https://img.shields.io/badge/Neural%20Net-6-ff69b4?style=flat-square) | Activation Model, ML Acti Pro, Learn ML Arctic, Activation Dashboard... |
| AI Applications | ![AI App](https://img.shields.io/badge/AI%20App-5-orange?style=flat-square) | GhostedAI, VibeCheck ML, AIGoverse, OpenRouter Explorer... |
| ML Libraries/Apps | ![ML App](https://img.shields.io/badge/ML%20App-3-green?style=flat-square) | Machine Learning App, Stock Market AI, NeuralOrbit |
